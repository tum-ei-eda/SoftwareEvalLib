...
InstructionMonitorSet *InstructionTrace_InstrMonitorSet = new InstructionMonitorSet("InstructionTrace_InstrMonitorSet");

static InstructionMonitor *instrMonitor_add = new InstructionMonitor(
  InstructionTrace_InstrMonitorSet,
  "add",
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 0 << ";\n";
    
    ret_strs << "InstructionTrace_Monitor_code_buffer[*InstructionTrace_Monitor_instrCnt] = " << ba << ";\n";
    
    ret_strs << "InstructionTrace_Monitor_pc_buffer[*InstructionTrace_Monitor_instrCnt] = " << ic.current_address_ << ";\n";
    
    ret_strs << "strcpy(InstructionTrace_Monitor_assembly_buffer[*InstructionTrace_Monitor_instrCnt],\"" << instr.printASM(ba) << "\");\n";
    
    ret_strs << "InstructionTrace_Monitor_rs1_data_buffer[*InstructionTrace_Monitor_instrCnt] = " << "*((RV32IMACFD*)cpu)->X[" <<  rs1_data  << "]" << ";\n";
    
    ret_strs << "InstructionTrace_Monitor_rs2_data_buffer[*InstructionTrace_Monitor_instrCnt] = " << "*((RV32IMACFD*)cpu)->X[" <<  rs2_data  << "]" << ";\n";
    ret_strs << "*InstructionTrace_Monitor_instrCnt += 1;\n"; // TODO: InstrCnt should be set in the post-print-function (see below). Currently set here, to makes sure that it is set, even if instruction triggers a return
    return ret_strs.str();
  },
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    std::stringstream ret_strs;
    ...
    ret_strs << "InstructionTrace_Monitor_rd_data_buffer[*InstructionTrace_Monitor_instrCnt] = " << "*((RV32IMACFD*)cpu)->X[" <<  rd_data  << "]" << ";\n";
    ret_strs << "*InstructionTrace_Monitor_instrCnt += 1;\n";
    return ret_strs.str();
  }
);
...
static InstructionMonitor *instrMonitor_addi = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rd_data_0(11,7);
    rd_data += R_rd_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 1 << ";\n";
...
static InstructionMonitor *instrMonitor_slli = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rd_data_0(11,7);
    rd_data += R_rd_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 2 << ";\n";
...
static InstructionMonitor *instrMonitor_lb = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rd_data_0(11,7);
    rd_data += R_rd_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 3 << ";\n";
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_mem_addr_buffer[*InstructionTrace_Monitor_instrCnt] = " << "load_address" << ";\n";
    
    ret_strs << "InstructionTrace_Monitor_mem_rdata_buffer[*InstructionTrace_Monitor_instrCnt] = " << "res" << ";\n";
    ret_strs << "*InstructionTrace_Monitor_instrCnt += 1;\n";
    return ret_strs.str();
  }
);
...
static InstructionMonitor *instrMonitor_sb = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rs2_data_0(24,20);
    rs2_data += R_rs2_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 4 << ";\n";
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_mem_addr_buffer[*InstructionTrace_Monitor_instrCnt] = " << "store_address" << ";\n";
    
    ret_strs << "InstructionTrace_Monitor_mem_wdata_buffer[*InstructionTrace_Monitor_instrCnt] = " << "mem_val_0" << ";\n";
    ret_strs << "*InstructionTrace_Monitor_instrCnt += 1;\n";
    return ret_strs.str();
  }
);
...
static InstructionMonitor *instrMonitor_csrrw = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 5 << ";\n";
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_csr_data_buffer[*InstructionTrace_Monitor_instrCnt] = " << "csr_read(cpu, system, plugin_pointers, " << imm << ")" << ";\n";
    ret_strs << "*InstructionTrace_Monitor_instrCnt += 1;\n";
    return ret_strs.str();
  }
);
...
static InstructionMonitor *instrMonitor_csrrwi = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_imm_0(31,20);
    imm += R_imm_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 6 << ";\n";
...
static InstructionMonitor *instrMonitor_beq = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rs2_data_0(24,20);
    rs2_data += R_rs2_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 7 << ";\n";
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_jump_pc_buffer[*InstructionTrace_Monitor_instrCnt] = " << "cpu->instructionPointer" << ";\n";
    ret_strs << "*InstructionTrace_Monitor_instrCnt += 1;\n";
    return ret_strs.str();
  }
);
...
static InstructionMonitor *instrMonitor_lui = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rd_data_0(11,7);
    rd_data += R_rd_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 8 << ";\n";
...
static InstructionMonitor *instrMonitor__def = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 9 << ";\n";
...
static InstructionMonitor *instrMonitor_jal = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rd_data_0(11,7);
    rd_data += R_rd_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 10 << ";\n";
...
static InstructionMonitor *instrMonitor_jalr = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    static etiss::instr::BitArrayRange R_rd_data_0(11,7);
    rd_data += R_rd_data_0.read(ba) << 0;
    ret_strs << "InstructionTrace_Monitor_typeId_buffer[*InstructionTrace_Monitor_instrCnt] = " << 11 << ";\n";
