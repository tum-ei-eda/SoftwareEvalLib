...
extern "C"
{
  ...
  char (*AssemblyTrace_RV64_Monitor_assembly_buffer)[150];
}
...
void AssemblyTrace_RV64_Monitor::connectChannel(Channel* channel_)
{
  ...
  AssemblyTrace_RV64_Monitor_assembly_buffer = static_cast<char(*)[150]>(channel_->getTraceValueHook("assembly"));
}
...
std::string AssemblyTrace_RV64_Monitor::getBlockDeclarations(void) const
{
  ...
  ret_strs << "extern char (*AssemblyTrace_RV64_Monitor_assembly_buffer)[150];\n";
